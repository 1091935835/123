...
if (randstroke == 3){
stroke(random(125),217,random(255));//Blue-Green
}
if (randstroke == 4){
stroke(255,random(220),random(233)); //hot pink
}
if (randstroke == 5){
stroke(255,random(20),2);//red-orange
}
if (randstroke == 6){
stroke(50,random(15,255),255);//Aqua-Blue
}
if (randstroke == 7){
stroke(random(20,25),10,random(230,255));//Purple
}
